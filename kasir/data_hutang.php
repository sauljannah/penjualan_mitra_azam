...
<!-- Script Inisialisasi Tema (Mencegah Layar Putih Berkedip saat Reload) -->
<script>
    (function() {
...
/* ======================================
   ...
   ====================================== */
[data-bs-theme="dark"] body { background: #0f172a !important; color: #f8fafc; }
[data-bs-theme="dark"] .navbar { background: #1e293b !important; border-bottom: 1px solid #334155 !important; }
[data-bs-theme="dark"] .card { background: #1e293b !important; color: #f8fafc; border: 1px solid #334155 !important; box-shadow: 0 5px 20px rgba(0,0,0,0.3) !important; }
...
[data-bs-theme="dark"] .table thead th { color: #94a3b8 !important; background: #1e293b !important; }
[data-bs-theme="dark"] .table-hover tbody tr:hover { background-color: rgba(255, 255, 255, 0.05) !important; color: #fff; }
[data-bs-theme="dark"] .table td, [data-bs-theme="dark"] .table th { border-color: #334155 !important; }
...
[data-bs-theme="dark"] .stat-card { background: #1e293b !important; color: #f8fafc !important; border: 1px solid #334155; }
[data-bs-theme="dark"] .stat-card h6 { color: #94a3b8 !important; }
...
<nav class="navbar bg-white fixed-top shadow-sm px-4" style="height: 70px;">
  <div class="container-fluid px-0 d-flex align-items-center justify-content-between">
    ...
    <button class="btn btn-sm btn-outline-secondary rounded-pill px-3 py-2 d-flex align-items-center gap-2" id="themeToggleBtn" onclick="toggleQuickTheme()">
        ...
        <span class="small fw-semibold d-none d-sm-inline" id="themeText">Theme</span>
    </button>
  </div>
</nav>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="sidebarKasir">
    ...
    <div class="sidebar-profile">
        ...
        <div class="profile-info">
            <h6><?= htmlspecialchars($_SESSION['nama'] ?? 'Kasir'); ?></h6>
            <span>
    ...
    <div class="offcanvas-body p-0">
        <div class="sidebar-nav-container">
            ...
            <a href="transaksi.php"><i class="bi bi-cart-fill"></i> Transaksi</a>
            <a href="data_hutang.php" class="active"><i class="bi bi-people-fill"></i> Data Hutang Customer</a>
...
<div class="container-fluid mt-4 px-4">
    <div class="header-card mb-4">
        <h2>
            <i class="bi bi-credit-card"></i> Data Hutang Customer
        </h2>
        <p class="mb-0">
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button onclick="konfirmasiLunasi(<?= $row['id_penjualan']; ?>)" class="btn btn-lunasi btn-sm">
...
<script>
    // Inisialisasi Tampilan Tombol Theme saat halaman dimuat
