...
<head>
    ...
    <style>
        * { font-family:'Poppins', sans-serif; }
        ...
        .card { border:none; border-radius:24px; overflow:hidden; box-shadow: 0 5px 20px rgba(0,0,0,0.08); background: #ffffff; }
    ...
    <div class="card header-card mb-4 shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="bg-white bg-opacity-25 py-2 px-3 rounded-4 border border-white border-opacity-25 text-white">
